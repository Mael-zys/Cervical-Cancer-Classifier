...
def main(args):
    if args.checkpoint == '':
        args.checkpoint = "checkpoints_multi_fpn/ic15_%s_bs_%d_ep_%d"%(args.arch, args.batch_size, args.n_epoch)
    if args.pretrain:
    ...
    for epoch in range(start_epoch, args.n_epoch):
        ...
        train_loss_plot(train_loss_list,val_loss_list,'train_val_loss_multi_fpn'+args.arch+'.png')
