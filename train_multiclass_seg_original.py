...
from models.resnet_original import *
...
def main(args):
    if args.checkpoint == '':
        args.checkpoint = "checkpoints_multi_seg/original_ic15_%s_bs_%d_ep_%d"%(args.arch, args.batch_size, args.n_epoch)
    if args.pretrain:
    ...
    if args.arch == "resnet50":
        model = resnet50(pretrained=True, num_classes=9)
    elif args.arch == "resnet101":
        model = resnet101(pretrained=True, num_classes=9)
    elif args.arch == "resnet152":
        model = resnet152(pretrained=True, num_classes=9)
    ...
    for epoch in range(start_epoch, args.n_epoch):
        ...
        train_loss_plot(train_loss_list,val_loss_list,'train_val_loss_multi_seg_original'+args.arch+'.png')
