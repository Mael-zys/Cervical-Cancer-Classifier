...
# python -u machine_learning_main.py --binary False --mask_mode True --extract_feature "martin" --cv_mode "Grid"
...
python -u machine_learning_main.py --classifier "SVM" --binary False --mask_mode True --extract_feature "martin_marina_dong" --cv_mode "Grid" --select_feature "RF" --num_components 50